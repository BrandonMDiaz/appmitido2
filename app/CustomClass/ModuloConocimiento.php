...
{
  public $reglas = [
    'lingüístico-verbal = Leer y ser autodidacta & bueno para hablar & redactar documentos',
    ...
    'creativa = leer y ser autodidacta & bajo presión & bueno diseñando & imaginativo & gusto por la innovación',
