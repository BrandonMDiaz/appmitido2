...
class VocacionController extends Controller
{
  ...
  public function orientador(Request $request){
    ...
    $texto = $this->texto($carrera);
    return view('orientador.resultado', compact('carrera', 'texto'));
  }

  public function texto($carrera){
    switch ($carrera) {
      case 'Derecho':
        return ["La carrera de Derecho es una disciplina, que brinda instrumentos para
